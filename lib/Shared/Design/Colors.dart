...
var main_color = anime_color_dark;
var secondary_color = anime_color_light;
const anime_color_dark = Color.fromARGB(255, 16, 53, 82);
const anime_color_light = Color.fromARGB(255, 191, 220, 237);
const community_color_dark = Color.fromARGB(255, 0, 56, 47);
const community_color_light = Color.fromARGB(255, 178, 233, 228);